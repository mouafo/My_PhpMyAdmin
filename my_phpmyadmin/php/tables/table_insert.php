        ...
        if (mysql_error() == "") {
             ?>
                    <div class="alert alert-success alert-dismissable">
                        ...
                        <?php 
                            $enr = $_GET["i_itt"] - $err;
                        echo $enr." Enregistrement(s) dans la table ".$_GET['tab']." a ete effectuer avec succes"; ?>
                    </div>
<?php
        }
    }
...
<section class="content">
        <p><b>Inserer un ou plusieurs enregistrement dans la table</b></p><br>
        Nombre d'element a inserer : 
        <form action="show.php?id=3&db=<?php echo $_GET['db'] ?>&tab=<?php echo $_GET['tab'] ?>" method="post" class="form" enctype="multipart/form-data" id="form0">
            <div class="form-group">
                <div class="row" style="vertical-align:middle;">
                    <div class="col-md-2">
                        <input type="number" name="it" class="form-control" style="width:180px; border-radius:5px;" value="1" min="0" />       
                    </div>
                    <div class="col-md-1">
                        <button type="submit" name = "go" class="btn bg-olive" style="width:100px;font-size:20px">Add</button>
                    </div>
                </div>
            </div>
        </form>
        <br/><br/>
    <form action="show.php?id=3&db=<?php echo $_GET['db'] ?>&tab=<?php echo $_GET['tab'] ?>&i_itt=<?php echo $qte_insert; ?>" method="post" class="form" enctype="multipart/form-data" id="form">
        <fieldset style = "border:radius 1px black;">
            <legend>Inserer</legend>
            <?php
            ...
            ?>
                ...
                ?>
                        <textarea name="<?php echo $i; ?>value<?php echo $row['Field']; ?>" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                <?php
                    }
        ...
        <?php } ?> <!-- end of for : determines the values to be inserted inside the db-->
            ...
            <div class="form-group" style="vertical-align:middle;"> <!-- insert button for the formular to insert the different values inside the table -->
                <button type="submit" name = "insert" class="btn bg-olive" style="width:100px;font-size:20px">Inserer</button>
            </div>  
        </fieldset>                                         
    </form>
    <br>
